...
public class BaseTest {
	...
	public void setup(String log)
		...
		if(log.equals("IsraelVpn"))
			...
			driver.get("http://192.168.20.162:5601/app/discover#/?_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-1h,to:now))&_a=(columns:!(),filters:!(),index:'13194c80-012b-11ed-ac7d-1d1fc75057d2',interval:auto,query:(language:kuery,query:'Event%20Name%20:%20%22File%20Delete%22'),sort:!(!('@timestamp',desc)))");
		else if(log.equals("FileCopy"))
			driver.get("http://192.168.20.162:5601/app/discover#/?_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-1h,to:now))&_a=(columns:!(),filters:!(),index:'13194c80-012b-11ed-ac7d-1d1fc75057d2',interval:auto,query:(language:kuery,query:'Event%20Name%20:%20%22File%20Copy%22'),sort:!(!('@timestamp',desc)))");
		else if(log.equals("FileWrite"))
			driver.get("http://192.168.20.162:5601/app/discover#/?_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-1h,to:now))&_a=(columns:!(),filters:!(),index:'13194c80-012b-11ed-ac7d-1d1fc75057d2',interval:auto,query:(language:kuery,query:'Event%20Name%20:%20%22File%20Write%22'),sort:!(!('@timestamp',desc)))");
		this.log = log;
	...
	public void getHits() {
		...
		if(log.equals("KievVpn") || log.equals("LvivVpn")) {
			...
			try {
				...
				mainPage.clickOnDetailsExpand();
				mainPage.getRelatedUserRedGrey();
				AssertJUnit.assertEquals(0, 1);
			}
		}else {
			/*try {
